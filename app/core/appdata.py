...
def backup_appdata(dest_dir: Path, on_line: Callable[[str], None], cancel_event: threading.Event | None = None) -> int:
    ...
    result = run_robocopy(source, dest_dir, on_line=on_line, cancel_event=cancel_event, extra_flags=exclude_args)
